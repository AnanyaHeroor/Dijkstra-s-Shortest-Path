 ...
 private static void welcome() {
   ...
   private static void add() {
     ...
     try {
         ...
         System.out.println("\nInvalid! Event may already exist or incorrect types were used. Try again: \n");
   ...
   private static void search() {
     ...
     int i =0;
     for(i=0; i< timemachine.catalog.size(); i++) {
       if(timemachine.catalog.get(i).getYear() == Integer.parseInt(year)) {
         int energy = timemachine.catalog.get(i).getEnergy();
         String description= timemachine.catalog.get(i).getDescription();
